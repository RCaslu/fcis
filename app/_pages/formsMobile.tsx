...
const MyForm = () => {
    ...
    return ( 
        <div className='flex justify-center text-center py-12 '>
            <div className='flex justify-center w-[410px] rounded-xl bg-white'>
            ...
            <div className='py-2'>
                    <input 
                        ...
                        className=" p-2 border w-[390px] border-gray-300 rounded text-black"
                    />
                </div>
                <div className='py-2'>
                    <input 
                ...
                <div className='py-4'>
                    <Button className='rounded-xl py-8 text-lg text-white w-[390px]' type='submit' variant={'blueFCS'} size={'ProjectButtonMobile'}>
